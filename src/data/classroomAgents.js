...
export const CLASSROOM_AGENTS_BY_GRADE = {
  10: {
    teacher: {
      name: "Sunita Ma'am", role: 'teacher', emoji: '\u{1F469}\u200D\u{1F3EB}', color: '#a78bfa',
    ...
    classmate1: {
      name: 'Meera', role: 'classmate1', emoji: '🤫', color: '#a8a29e', archetype: 'shy',
    ...
    classmate2: {
      name: 'Vikram', role: 'classmate2', emoji: '🙋‍♂️', color: '#f9a8d4', archetype: 'outgoing',
    ...
    classmate3: {
      name: 'Aabha', role: 'classmate3', emoji: '📚', color: '#5eead4', archetype: 'studious',
    ...
    classmate4: {
      name: 'Optimus', role: 'classmate4', emoji: '🎭', color: '#fb923c', archetype: 'wildcard',
  ...
  7: {
    teacher: {
      name: "Rupa Ma'am", role: 'teacher', emoji: '\u{1F469}\u200D\u{1F3EB}', color: '#a78bfa',
    ...
    classmate1: {
      name: 'Priya', role: 'classmate1', emoji: '🤫', color: '#a8a29e', archetype: 'shy',
    ...
    classmate2: {
      name: 'Arjun', role: 'classmate2', emoji: '🙋‍♂️', color: '#f9a8d4', archetype: 'outgoing',
    ...
    classmate3: {
      name: 'Diya', role: 'classmate3', emoji: '📚', color: '#5eead4', archetype: 'studious',
    ...
    classmate4: {
      name: 'BumbleBee', role: 'classmate4', emoji: '🐝', color: '#fde047', archetype: 'wildcard',
